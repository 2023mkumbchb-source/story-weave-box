*A consolidated Year 1 Anatomy spot-question bank for the Aponeurosis collection, drawn from eight revision papers and one lecture, organised by body region rather than by source paper — pelvis through hand for the lower and upper limbs, plus the vertebral column, skull, breast, and reference figures. Tap any answer to reveal it.*
...
- Iliofemoral ligament
- Straight head of rectus femoris
- Both attach at the anterior inferior iliac spine (AIIS)
...
- Arise from ascending cervical branches of the extracapsular arterial ring
- Ring formed anteriorly by the lateral circumflex femoral artery
- Ring formed posteriorly by the medial circumflex femoral artery
- Clinical relevance: risk of avascular necrosis after a fracture of the neck of femur
- Iliopsoas tendon attaches at the lesser trochanter
- Innervation: femoral nerve (L2–L4) for iliacus
- Innervation: L1–L3 (ventral rami) for psoas major
...
- Flexes the hip
- Extends the knee
- (most two-joint muscles have opposite actions at each joint — sartorius is an exception)
- X: iliotibial tract
- Tensor fasciae latae inserts here — superior gluteal nerve (L4, L5, S1)
- Gluteus maximus also inserts here — inferior gluteal nerve (L5, S1, S2)
...
- Gives perforating branches (supply the posterior thigh muscles)
- Gives the medial and lateral circumflex femoral arteries (supply the femoral head)
- M: adductor longus (forms part of the floor of the adductor/Hunter's canal)
- Other floor muscle: adductor magnus
- Roof of the canal: sartorius
...
**Answer:**
- Ischial spine
- Landmark for pudendal nerve block (pudendal anesthesia)
- Pudendal nerve root value: S2, S3, S4
- "PINT" mnemonic tendon: obturator internus
...
- Fascia lata modification: intermuscular septa
- Fascia lata modification: saphenous opening (fossa ovalis)
- Positive Trendelenburg sign: hip abductor (gluteus medius/minimus) dysfunction
- Causes: superior gluteal nerve injury, superior gluteal vessel injury, hip joint arthritis, hip dislocation
...
- These form a longitudinal anastomosis
- S: piriformis
- Originates from the anterior aspect of the middle three sacral pieces
...
- If trapezius: innervation is the spinal accessory nerve (CN XI); actions include scapular rotation/elevation/retraction
- If latissimus dorsi: origin is the thoracolumbar fascia, iliac crest, lower ribs, and inferior angle of the scapula; innervation is the thoracodorsal nerve; actions are adduction, medial rotation, and extension of the arm
...
- B: claw hand — ulnar nerve injury
- Axillary nodes have five groups: lateral, anterior (pectoral), posterior (subscapular), central, apical
- Lateral, anterior and posterior groups drain into the central group, which drains into the apical group
- Importance: this pattern lets the spread of infection or cancer (e.g. breast cancer) be traced and staged
...
- Clinical significance: landmark for a pudendal nerve block
...
- A — piriformis muscle
- B — sciatic nerve
- Two non-neural contents of the lesser sciatic foramen:
- Tendon of obturator internus
- Internal pudendal vessels
...
- Nerves involved:
- Long thoracic nerve (serratus anterior palsy — the classic cause)
- Also implicated: dorsal scapular nerve; spinal accessory nerve (depending on which scapular stabilizer is affected)
...
- 3/4 into Gerdy's tubercle via the iliotibial tract
- 1/4 into the gluteal tuberosity of the femur
- Nerve B (sciatic nerve) root value and distribution: sacral plexus (S1, S2, S3)
...
- Strong adductor of the hip
- Medial rotator of the hip
- Cutaneous innervation of the medial thigh: medial cutaneous nerve of the thigh (a branch of the femoral nerve)
...
- Structures attaching at Z: hamstring muscles; hamstring part of adductor magnus
...
- B — ligamentum teres (round ligament of the femoral head)
- C — acetabular labrum
- Main stability factors of the hip joint:
- Bony anatomy — the most important factor
- The labrum — contributes via a "suction seal" effect, creating negative pressure between the femoral head and acetabulum
...
- Unlocks the knee
- Prevents forward dislocation of the femur while crouching
- Blood supply to the sciatic nerve: segmental — perforating branches from the profunda femoris artery, supplemented by the inferior gluteal, internal pudendal, and medial circumflex femoral arteries
...
- If Q = saphenous nerve: purely sensory; supplies the knee joint via the subsartorial plexus, skin over the front of the patella, and the anteromedial leg
- If Q = vastus medialis (oblique fibres): pulls the patella medially, resisting lateral dislocation
- Other stabilising factors: the medial patellofemoral ligament
- Other stabilising factors: the prominent lateral femoral condyle / deep trochlear groove
...
- In the popliteal fossa, the parent nerve gives branches to gastrocnemius, popliteus, soleus, plantaris
- Also gives an articular branch to the knee
- Gives a cutaneous branch that becomes the sural nerve (joined by a contribution from the common fibular nerve)
- Sural nerve supplies the lateral side of the foot
- Fracture displacement: posterior displacement of the distal fragment
- Cause: pull of gastrocnemius, which originates from the supracondylar ridge
...
- A — semimembranosus
- B — biceps femoris
- Two mechanisms of venous return from the lower limb:
- Soleal pump
- Sole (plantar venous) pump
...
- Two bursae around the knee: prepatellar bursa; suprapatellar bursa
- Also visible in this image (for revision): anserine bursa; deep infrapatellar bursa
...
- Peroneus longus and biceps femoris tendon
- Two modifications of the fascia lata:
- Iliotibial band
- Saphenous opening (also: septations forming intermuscular septa)
...
- Q angle
- Sweeping fibres of vastus medialis; the lateral tubercle of the femur also contributes
- Two structures attaching on area X of bone B:
- Anterior cruciate ligament
- Anterior edge of the menisci
...
- Structures deep to B (subsartorial/adductor canal): nerve to vastus medialis; saphenous nerve; femoral vessels
...
- Innervation: recurrent (motor) branch of the median nerve
- Other thenar muscles in this group: flexor pollicis brevis, opponens pollicis (all median nerve, except adductor pollicis which is ulnar)
...
**Answer:**
- Peroneus tertius
- Static stability: the mortise-and-tenon (talocrural) joint structure itself
- Static stability: deltoid ligament
- Static stability: anterior and posterior talofibular ligaments
- Static stability: distal tibiofibular ligament
- Static stability: calcaneonavicular ligament
- Dynamic stability: all tendons of the anterior and posterior leg compartments crossing the joint
...
**Answer:**
- Tibialis posterior
- Actions: inversion and plantarflexion of the foot
- N: the plantar "watershed" area
- Proximal part receives blood supply from the muscles forming it
- Distal part receives blood supply from the plantar aponeurosis
- Middle segment has poor blood supply
- Clinical relevance: slow healing after injury in this zone
...
**Answer:**
- Left talus
- Sided by the "table-top test": with the rounded head pointing forward, the trochlear surface (convex front-to-back, concave side-to-side) faces upward
- No muscle inserts directly on the talus — this was left unanswered in the original source, but it's worth knowing that no tendon attaches to it at all
- Clinical relevance: with only ligamentous attachments and a retrograde blood supply, the talus is prone to avascular necrosis after a talar neck fracture
- Inversion/eversion occur at the subtalar joint
- Inversion/eversion also occur at the talocalcaneonavicular joint
- (the calcaneocuboid joint contributes too, as part of the transverse tarsal joint)
...
- Terminal distribution: continues as the lateral cutaneous nerve of the forearm, supplying the lateral forearm
- L: median nerve
- Cause of injury: supracondylar humeral fractures
- Cause of injury: inflammation of tendons at the carpal tunnel
...
- Pattern of blood supply: retrograde (blood enters distally and flows proximally — a reason the talus is prone to avascular necrosis after a fracture)
...
- B — saphenous nerve
- Two structures behind the lateral malleolus: peroneus longus; peroneus brevis
...
- Y (peroneus longus tendon) attachments: base of the 1st metatarsal and the medial cuneiform
...
- X — supinator muscle
- Y — median nerve
- Two causes of claw hand: damage to the ulnar and median nerves; damage to the blood supply of the lumbrical muscles
...
**Answer:**
- Midpalmar space
- Proximally: continuous with the space of Parona in the forearm (via the carpal tunnel)
- Distally: communicates with the web spaces/dorsum of the fingers via the lumbrical canals
- Neighbouring space: the thenar space, separated from it by a fascial septum
...
**Answer:**
- Median nerve
- (a) Site: carpal tunnel, deep to the flexor retinaculum
- (b) Roots: C6, C7, C8, T1
- Clinical correlate: carpal tunnel syndrome — numbness of the lateral 3½ digits

---

# Lower Limb — Reference Figures

*Fully labelled reference figures from Dr. Anne Pulei's "Limb Anatomy: Revision" lecture — use these for revision alongside the spot questions above.*
...
**Answer:**
- M: phrenic nerve
- Root value: C3, C4, C5 (source key states "C1–C5"; the classical root value is C3–C5, with C4 as the major contributor)
- The phrenic nerve innervates the diaphragm and, via visceral afferents, the biliary apparatus
- Referred pain to the right shoulder occurs because the phrenic nerve (C3–C5) shares spinal cord segments with the supraclavicular nerves, which supply the shoulder skin
...
- B — dorsal nerve root
- Stability factors of the spinal cord:
- Continuation with the brainstem
- Spinal nerves
...
- Y — lamina
- Two ligaments attaching to Z (spinous process): supraspinous ligament; interspinous ligament
...
- Absorbs shock/compressive load
- Prevents friction between vertebral bodies
- Permits slight movement between vertebrae, contributing to overall spinal flexibility
...
- Loss of motor innervation to the upper limb
- Varieties of D (encephalocele-type swelling):
- Meningocele
- Myelomeningocele
- Related, also worth knowing: syringomyelia (a related spinal cord anomaly, not a variety of D itself)
...
- B — interneuron — structurally bipolar
- C — afferent (sensory) neuron — structurally unipolar (pseudounipolar)
...
**Answer:**
- A — lumbar vertebra
- B — cervical vertebra (atlas, C1)
- Main structure traversing X (transverse foramen of the atlas): vertebral artery
- Structure attaching at Y (posterior tubercle/arch region): apical ligament of the dens (and posterior atlanto-occipital membrane region)
...
- C — straight sinus
- D — occipital sinus
- Two contents of A (superior sagittal sinus): venous blood; cerebrospinal fluid (reabsorbed via arachnoid granulations)
...
- B — hypertrichosis: basis is excessive growth of hair follicles
...
- A — frontal air sinus
- B — crista galli
- Two structures passing through C (superior orbital fissure region):
...
- B (posterior fontanelle) closes: 9 months
...
**Answer:**
- G — optic chiasma
- H — sphenoidal air sinus
- Foramen of exit of E: superior orbital fissure
- Foramen of exit of F: foramen rotundum
...
- Sensory innervation of D: dorsal rami of cervical spinal nerves
- Two primary lymph node groups draining the scalp:
- Occipital lymph nodes (posteriorly)
- Parotid lymph nodes (anteriorly)
...
- Immediate termination of C: internal jugular vein
- Immediate termination of D: subclavian vein
...
- Main nerve supplying the tentorium cerebelli: meningeal branches of the vagus nerve
- Main artery supplying the posterior cranial dura: ascending meningeal artery
...
**Answer:**
- A — deltoid muscle
- B — clavicular head of pectoralis major
- Two actions of C (pectoralis major) on the arm: adduction; medial rotation
...
- Used to divide the axillary artery into its three parts
- Used for the surgical grouping of axillary lymph nodes (levels I, II, III relative to the muscle)
...
- Two sites of injury to the radial nerve in the arm: mid-shaft of the humerus at the radial (spiral) groove; in the axilla; also at the lateral intermuscular septum
...
- Pierces coracobrachialis, then runs between biceps and brachialis
...
**Answer:**
- Cephalic vein
- Begins at the roof of the anatomical snuffbox (wrist)
- Ascends the lateral forearm and arm
- Passes through the deltopectoral groove
- Pierces the clavipectoral fascia
- Drains into the axillary vein
- Related structure in this region: the deltopectoral (infraclavicular) lymph nodes lie alongside it
...
- Axillary vein also passes through this region
- Axillary lymph nodes are also found here
...
- B: coracoclavicular ligament (trapezoid and conoid parts)
- Note: verify letters against the source image before publishing
...
- B: radial nerve injury — wrist drop (unopposed flexion of the hand)
- In coarctation of the aorta distal to the subclavian artery origin, blood is diverted through the subclavian artery
- This markedly enlarges its branches contributing to the scapular anastomosis
- The dilated collateral vessels pulsate in time with the heartbeat
...
- Structures traversing it: radial nerve; profunda brachii (deep brachial) artery
...
- A — brachialis muscle
- B — radial nerve
- Two branches of the lateral cord of the brachial plexus: lateral division of the median nerve; musculocutaneous nerve
...
- Also gives sensory branches to the shoulder joint and acromioclavicular joint
...
- Root value: C6
- Root value: C7
- Runs down over the outer surface of serratus anterior
- Supplies serratus anterior
- Injury causes winging of the scapula
...
- Action: initiates/assists shoulder abduction (first 15°)
- Action: stabilises the humeral head in the glenoid (rotator cuff)
- Other rotator cuff muscles attaching near this part: infraspinatus and teres minor (posterior facet), subscapularis (lesser tuberosity)
...
- Basis: both wind directly around the surgical neck of the humerus
- Basis: they pass through the quadrangular space at this level
- Clinical result of axillary nerve injury: deltoid paralysis and "regimental badge" sensory loss
...
- Also part of the rotator cuff on this MRI: infraspinatus and teres minor tendons (posteriorly)
...
- Action: rotates the scapula upward (needed for full arm abduction/flexion above horizontal)
- Innervation: long thoracic nerve
...
- Insertion: distal radius (near the styloid process)
- Action: flexes the elbow joint
- Tennis elbow (lateral epicondylitis): pain from excessive/repetitive use of the forearm extensor muscles at their common origin
...
**Answer:**
- Pronator quadratus
- Non-neurovascular content of the cubital fossa: tendon of biceps brachii
- Tinel's sign: a tingling sensation produced when an irritated/regenerating nerve is tapped
- Used to test the functional recovery of a nerve
...
- A — ulnar nerve
- B — median nerve
- Two dually innervated muscles in the upper limb:
- Brachialis
- Flexor digitorum profundus
- Also accepted: flexor pollicis brevis (dual innervation from median and ulnar nerves)
...
- B (radial nerve, radial groove) root value: C5–T1
- Motor distribution of nerve C (ulnar nerve) in the forearm: flexor carpi ulnaris; medial (ulnar) half of flexor digitorum profundus
...
- Coracobrachialis
- Biceps brachii
- Also supplies brachialis (any two accepted)
...
- Brachialis action: pure elbow flexor regardless of forearm position
...
**Answer:**
- Brachial artery
- Terminates in the cubital fossa
- At the level of the neck of the radius
- Bifurcates into the radial artery
- Bifurcates into the ulnar artery
- Runs with the median nerve in the arm (nerve lies medial to it)
...
**Answer:**
- Median cubital vein
- Clinical utility: standard site for venepuncture and IV cannulation
...
- Together these form the deep palmar arch
- Surface landmark: fully extend the thumb and draw a line across the palm from the distal border of the thumb — this marks the level of the superficial palmar arch (Boeckel's line)
- The deep palmar arch lies about a finger's width proximal to this line
...
- Clinical utility of X (the anatomical snuffbox): site of the radial pulse; overlies the scaphoid, so tenderness here suggests a scaphoid fracture
...
- A — scaphoid
- G — capitate
- Terminal branches of the radial artery: princeps pollicis artery; radialis indicis artery
...
- B — capitate
- Two actions of the hand lumbricals: flexion of the metacarpophalangeal joints; extension of the interphalangeal joints
...
- Cubital tunnel (behind the medial epicondyle, between the two heads of flexor carpi ulnaris)
...
- 5: trapezoid
- 7: hamate
- Remaining carpal bones for full recall: scaphoid, lunate, capitate, pisiform
- Mnemonic (proximal to distal, lateral to medial): "Some Lovers Try Positions That They Cannot Handle"
...
**Answer:**
- A: median nerve
- B: a branch of the musculocutaneous nerve (lateral cutaneous nerve of forearm), or brachial vessels at the elbow
- C, D: cutaneous branches/vessels of the forearm
- Note: verify letters against the source image before publishing
...
- One proper palmar digital artery to the little finger
- Compare: the deep palmar arch (mainly radial artery) lies deeper, gives palmar metacarpal arteries
...
- Divides near the elbow, at the level of supinator
- Superficial branch supplies skin over the dorsum of the hand (lateral 3½ digits)
...
**Answer:**
- Pisiform
- Flexor carpi ulnaris inserts here
- Abductor digiti minimi also originates from it
- It is a sesamoid bone within the FCU tendon
...
- Inserts on the base of the 2nd (and 3rd) metacarpal

---

# Upper Limb — Reference Figures
...
- 2 — capitulum
- 3 — trochlea
- 4, 5 — greater and lesser tubercles
- 9, 10 — coronoid fossa margins
- 11 — anatomical neck
- 6, 7 (posterior view) — greater tubercle and olecranon fossa
...
- Proximal and distal radio-ulnar joints act together
- High mobility of the 1st carpometacarpal joint comes from its saddle-shaped joint surfaces
- Also from the surrounding thenar muscles, which actively increase its range of motion
- It is the joint between the first metacarpal and the trapezium (angle formed with the first phalanx is relevant to thumb movements)

---
*Compiled from a University of Nairobi student SPOT-question collection ("Aponeurosis 01"), originally assembled by Jose Kariuki (Jitu) with contributions from department lecturers, demonstrators and students. Answers transcribed from the original compiler's answer key (sent 11 June 2017); two items (Q4, Q13) have internal inconsistencies in the source key that are flagged above for verification.*
...
- Also present at this joint: the annular ligament (encircles the radial head)
...
- B: myofibrils showing cross-striation
- Also visible: the sarcolemma (cell membrane) and endomysium between fibres
...
- Full epidermal layer sequence (deep to superficial): stratum basale, stratum spinosum, stratum granulosum, stratum lucidum (thick skin only), stratum corneum

---

# Limb Anatomy — Additional Practice Questions
...
- Muscles typically asked about at the ischial tuberosity: the hamstrings (semitendinosus, semimembranosus, long head of biceps femoris) and part of adductor magnus
- Structures through the greater sciatic foramen: sciatic nerve; superior and inferior gluteal vessels and nerves; pudendal nerve; internal pudendal vessels
...
- Two actions of biceps femoris: flexes the knee; laterally rotates the flexed knee (also extends the hip)
...
- Two structures attached to the anterior intercondylar area of the tibia: anterior cruciate ligament; anterior horn of the medial meniscus
...
- Two structures in the popliteal fossa: tibial nerve; common fibular (peroneal) nerve
- Also accepted: popliteal vein; popliteal artery; small saphenous vein
...
- Medial epicondyle: common flexor origin of the forearm flexors
- Lateral epicondyle: common extensor origin of the forearm extensors
...
- Components of the rotator cuff ("SITS"): supraspinatus; infraspinatus; teres minor; subscapularis
...
- Branches of the lateral cord: lateral pectoral nerve; musculocutaneous nerve; lateral root of the median nerve
- Branches of the posterior cord: upper and lower subscapular nerves; thoracodorsal nerve; axillary nerve; radial nerve
- Branches of the medial cord: medial pectoral nerve; medial cutaneous nerves of the arm and forearm; ulnar nerve; medial root of the median nerve
- Branches from the roots/trunks: dorsal scapular nerve; long thoracic nerve; nerve to subclavius; suprascapular nerve
...
- Ulnar nerve: flexor carpi ulnaris; ulnar half of flexor digitorum profundus; most small hand muscles (interossei, hypothenar muscles, adductor pollicis, the two medial lumbricals)
- Radial nerve: triceps brachii; all the extensor muscles of the forearm (via its posterior interosseous branch)
...
- Two muscles causing medial (ulnar) deviation at the wrist: flexor carpi ulnaris; extensor carpi ulnaris
...
- Contents: tendons of flexor digitorum superficialis and flexor digitorum profundus; tendon of flexor pollicis longus; median nerve
...
- Median nerve cutaneous distribution: palmar surface of the lateral 3½ digits and the corresponding palm
- Radial nerve cutaneous distribution: dorsal surface of the lateral 3½ digits (over the proximal phalanges) and the dorsum of the lateral hand
- Ulnar nerve cutaneous distribution: palmar and dorsal surface of the medial 1½ digits and the corresponding medial hand
