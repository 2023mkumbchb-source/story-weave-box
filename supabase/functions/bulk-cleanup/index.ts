...
const CATEGORY_KEYWORDS: Record<string, string[]> = {
  ...
  "Year 3: Basic Pharmacology III": ["pharmacology", "pharmacokinetic", "pharmacodynamic", "drug", "receptor", "agonist", "antagonist"],
  ...
  "Year 3: Bone and Soft Tissue Pathology": ["bone pathology", "soft tissue", "osteosarcoma", "fracture pathology"],
  ...
  "Year 3: General Pathology": ["general pathology", "inflammation", "neoplasia", "cell injury", "wound healing", "thrombosis"],
