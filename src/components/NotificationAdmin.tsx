...
export default function NotificationAdmin() {
  ...
  return <div className="space-y-6">
    ...
    <div className="space-y-4 rounded-xl border border-border bg-card p-4 sm:p-5">
      ...
      <div><label className="mb-1.5 block text-sm font-medium">Optional Ompath Study link</label><Input value={actionUrl} onChange={(e) => setActionUrl(e.target.value)} placeholder="https://www.ompathstudy.com/my-revision" /></div>
